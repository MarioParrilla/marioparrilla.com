const ImageCard = (icon: { icon: string; alt: string; title: string; }) => {
    ...
    return (
        <div className='flex flex-col shadow-md dark:shadow-zinc-700 rounded-2xl border mb-5 dark:bg-zinc-800 dark:border-zinc-700 dark:text-white bg-white min-[320px]:h-32 md:h-48 lg:h-48  min-[320px]:w-32 md:w-40 lg:w-48 px-2'>
