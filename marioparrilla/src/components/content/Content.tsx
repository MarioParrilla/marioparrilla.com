        ...
        <div className='flex-auto w-50% min-h-screen'>
            <div className='my-10 min-[320px]:mx-5 md:mx-20'>
                ...
                <div className='flex flex-row flex-wrap space-x-4'>
                    ...
                    <ProjectCard title='SnakeCore' desc={getTranslation('snakecore')} lang="Java" web="https://snakecore.vercel.app/" github="https://github.com/MarioParrilla/SnakeCore" icon={snakecoreIcon} alt="SnakeCore" />
                    <ProjectCard title='SnakeCore Website' desc={getTranslation('mpweb')} lang="React" web="https://snakecore.vercel.app/" github="https://github.com/MarioParrilla/marioparrilla.com/tree/main/snakecore" icon={snakecoreIcon} alt="SnakeCore" />
