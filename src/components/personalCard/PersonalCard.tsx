...
const PersonalCard = () => {
    return (
        <div className='flex flex-row rounded-2xl shadow-md dark:shadow-zinc-700 border mb-5 dark:bg-zinc-800 dark:border-zinc-700 dark:text-white bg-white max-w-7xl'>
