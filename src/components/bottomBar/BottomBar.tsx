import { changeCurrentLang, currentLang } from "../../services/LangService";
...
window.onscroll = () => {
    ...
    if (prevScrollpos > currentScrollPos) {
        document.getElementById('btmnv')!.classList.remove('hiddenT');
        document.getElementById('btmnv')!.classList.add('showT');
    } else {
        document.getElementById('btmnv')!.classList.remove('showT');
        document.getElementById('btmnv')!.classList.add('hiddenT');
    }
...
const BottomBar = () => {
    ...
    return (
        <div id='btmnv' className="md:block lg:hidden dark:bg-zinc-800 bg-gray-200 w-screen h-20 fixed bottom-0">
