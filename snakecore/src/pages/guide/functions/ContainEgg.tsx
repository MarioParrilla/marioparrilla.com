...
const ContainEgg = (data: { features: Array<Feature> }) => {
    return (
                ...
                <div className='flex flex-col md:px-20 lg:px-20 xl:px-40 sm:px-5 max-sm:px-5'>
                    ...
                    <div className='w-[50%] sm:w-[100%] max-sm:w-[100%] mb-5'>
                        <p className='text-xl text-black dark:text-white'>
                            This function will return through differents ways if exist one {<Link to='/guide/annotations/egg' className='font-bold inline hover:text-yellow-600'>Egg</Link>} in the context with those data.
                        </p>
                        <br />
                        <ShowCode lang='java' title='Main.java' code={CodeExampleService.getCodeExample({ id: 'containEgg()' })} />
                    </div>
                </div>
            </div>
        </div >
