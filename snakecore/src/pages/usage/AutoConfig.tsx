...
const AutoConfig = (data: { features: Array<Feature> }) => {
            ...
            <div className='flex-auto flex flex-col max-h-screen overflow-y-scroll bg-white dark:bg-zinc-900'>
                ...
                <div className='flex flex-col md:px-20 lg:px-20 xl:px-40 sm:px-5 max-sm:px-5'>
                    ...
                    <div className='w-[50%] sm:w-[100%] max-sm:w-[100%] mb-5'>
                        <TabShowCode tabs={[
                            { lang: 'java', title: 'Main.java', code: CodeExampleService.getCodeExample({ id: 'showMainAutoConfig' }) },
                            { lang: 'java', title: 'CestClass.java', code: CodeExampleService.getCodeExample({ id: 'showCestAutoConfig' }) },
                        ...
                        <br />
                        <ShowCode lang='java' title='Output' code={CodeExampleService.getCodeExample({ id: 'showInitOutputAutoConfig' })} showLineNumbers={false} wrapLongLine={true} />
                    </div>
                    <br />
                </div>
            </div>
